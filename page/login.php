<div id="main-login-wrapper">
    <section class="login uk-card uk-card-default">
        ...
        <div class="uk-card-body bottom-round">
            <form action="" class="uk-form-horizontal" autocomplete="none" method="post">
                ...
                <button id="login-asguest" class="uk-button uk-button-text login-guest uk-align-center" type="button" name="guest" value>Continue as guest user</button>
            </form>
        </div>
    </section>
</div>
